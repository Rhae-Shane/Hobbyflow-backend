-- HobbyFlow initial schema
-- Tables: profiles (auto-created on signup), user_plans (client sync via RLS)
...
create index user_plans_updated_at_idx on public.user_plans (updated_at desc);
