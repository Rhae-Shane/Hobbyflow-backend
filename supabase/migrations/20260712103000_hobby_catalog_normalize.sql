-- Upgrade: replace flat hobby_catalog with hobby_category + all_hobbies.
-- Safe if hobby_catalog was never created, or if normalized tables already exist.

drop table if exists public.hobby_catalog cascade;
